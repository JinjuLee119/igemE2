...
```{r}
no <- c(1,2,3,4,5)
part_id <- c("BBa_K3002004","BBa_K3002005","BBa_K3002014","BBa_K3002029","BBa_K3002037")
part_name <- c("Wildtype PETase for Chlamydomonas reinhardtii (Phytobrick)","Wildtype MHETase for Chlamydomonas reinhardtii Part 1 (Phytobrick)","Mutant PETase for Chlamydomonas reinhardtii (Phytobrick)","Wildtype MHETase for Chlamydomonas reinhardtii Part 2 (Phytobrick)","Wildtype MHETase for Chlamydomonas reinhardtii (Phytobrick)")
part_type <- c("Coding","Coding","Coding","Coding","Coding")
team_id <- c(1,1,1,1,1)
